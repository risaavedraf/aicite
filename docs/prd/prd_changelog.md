...
|---|---|---|---|---|---|---|
| 2026-05-26 | `docs/prd/README.md` | Reframed the PRD around a CLI-first AI harness and added the future native app and changelog to the document map. | TBD | worker | gpt-5.4-mini | Initial CLI-first rewrite. |
...
| 2026-05-26 | `docs/prd/05-non-functional-requirements.md` | Reworked quality, security, observability, and CLI ergonomics for the harness. | TBD | worker | gpt-5.4-mini | Initial CLI-first rewrite. |
...
| 2026-05-26 | `docs/prd/11-risks-open-questions.md` | Updated risks, trade-offs, and decision log for the CLI-first harness and future native app. | TBD | worker | gpt-5.4-mini | Initial CLI-first rewrite. |
